    ...
    */
    ...
    describe('The menu', function() {
         ...
         */
          ...
          */
          ...
          it('is changing by clicking', function() {
    ...
    describe('Initial Entries', function() {
         ...
         */
         ...
         it('feed has a not empty entry', function(done) {
...
// feed 0 done loading
             firstNews = allFeeds[0];

             loadFeed(allFeeds.length - 1, function(){

// feed 1 done loading
               lastNews = allFeeds[allFeeds.length - 1];
...
// all variables initialized, can begin tests
         ...
         it('feed is changed', function(done) {

           expect(firstNews).not.toBe(lastNews);
           done();
